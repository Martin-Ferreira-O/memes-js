...
var BASEURL = 'https://www.reddit.com/r/{url}.json?sort=top&t=day&limit=100';
/**
 *
 ...
 */
function getMeme(url, force) {
    if (force === void 0) { force = false; }
    return __awaiter(this, void 0, void 0, function () {
        var data, res, json, memes, randomMeme;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, node_fetch_1.default(BASEURL.replace("{url}", url), { "method": "GET", headers: { 'Content-Type': 'application/json' } })];
                case 1:
                    res = _a.sent();
                ...
                case 2:
                    ...
                    if (!/^.*\.(jpg?g|png|gif|gifv)$/.test(randomMeme.url) && force)
                        return [2 /*return*/, getMeme(url, true)];
                    data = {
